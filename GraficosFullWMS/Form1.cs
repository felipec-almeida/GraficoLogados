...
namespace GraficosFullWMS
{
    public partial class Form1 : Form
    {
        ...
        private List<double> TotalLogados = new List<double>();

        private List<string> connectionsString = new List<string>();
        private FileOperations<List<ConnectionSave>> fileOperations;

        //Lista Junta Gráficos
        private List<double> JuntaGraficosLogados = new List<double>();
        private List<double> JuntaGraficosColaboradores = new List<double>();
        private List<double> JuntaGraficosTotalLogados = new List<double>();
